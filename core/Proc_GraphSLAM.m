function [ Omega, Xi, Alpha ] = Proc_GraphSLAM( ...
    Alpha, HashTable_Idx, HashTable_Cnstr, Cnstr_Pool_Cell )
%PROC_BLDINFOALL_V2 Summary of this function goes here
%   Detailed explanation goes here
    ...
    Omega(1:3,1:3) = Omega(1:3,1:3) + eye(3)*1000000;    
    Alpha = Omega\Xi;
end
